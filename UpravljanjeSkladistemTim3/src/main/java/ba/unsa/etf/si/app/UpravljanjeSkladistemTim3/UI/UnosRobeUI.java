...
public class UnosRobeUI {
	...
	public static boolean DodajArtikal(JLabel status, JTable tabela, String ean, int kolicina, String nabavnaCijena) {
		if(!ValidateEan(ean)) {
		...
		int res = UposlenikBLL.DodajArtikal(ean, kolicina, Double.parseDouble(nabavnaCijena));
	...
	public static boolean DodajNoviArtikal(JLabel status, JTable tabela, String ean, int kolicina, String nabavnaCijena, String naziv, String jedinicnaKolicina, MjernaJedinica mjernaJedinica, String prodajnaCijena) {
		// Copy-paste refactor!
		if(naziv.length() == 0) {
		...
		int res = UposlenikBLL.DodajNoviArtikal(ean, kolicina, Double.parseDouble(nabavnaCijena), naziv, mjernaJedinica, Double.parseDouble(jedinicnaKolicina), Double.parseDouble(prodajnaCijena));
	...
	public static boolean UnosNabavke(JLabel status, Uposlenik user, String poslovniPartner, String barKod) {
		if (poslovniPartner.length() == 0) {
		...
		int res = UposlenikBLL.DodajNabavku(barKod, user, poslovniPartner);
		if(res == 1) {
